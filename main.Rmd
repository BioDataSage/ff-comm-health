...
# p3 <- age_class |>
#   ggplot(aes(x = 2, y = percent, fill = Age_class)) +
#   geom_col(width = 0.8)+
#   xlim(0.5,2.5)+
#   coord_polar(theta = "y")+
#   theme_void()+
...
#   scale_fill_manual(values = c("Youth"="#E69F00","Older Persons"="#A67C52", "Working Age"="#009E73"))+
#   theme(text = element_text(family = "Century Gothic", face = "bold", size = 12))+
#   labs(fill=NULL, title = "Distribution of Patients by Age Groups")
...
plot4 <- service |> 
  ...
  theme(text = element_text(family = "Century Gothic", face = "bold", colour = "white"),
    panel.background = element_blank(),
    ...
    axis.text.x = element_text(size = 13, family = "Century Gothic", face = "bold", vjust = 6, colour = "white"),
    axis.text.y = element_text(size = 12, family = "Century Gothic", face = "bold", colour = "white"),
    axis.title = element_text(size = 12, family = "Century Gothic", face = "bold")
    # axis.line.x = element_line(colour = "black", linewidth = .5),
    # axis.line.y = element_line(colour = "black", linewidth = .5),
  )+
